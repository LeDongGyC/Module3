...
<div class="row">
    ...
    <div class="col-md-8">
        <p><a href="/rentType?action=create">Add New Rent Type</a></p>
        <p><span>${mess}</span></p>
        <table class="table table-striped">
            ...
            <c:forEach items="${rentTypeList}" var="rentType" varStatus="status">
                <tr>
                    <td>${status.count}</td>
                    <td>${rentType.rentTypeId}</td>
                    <td>${rentType.rentTypeName}</td>
                    <td>${rentType.rentTypeCost}</td>
                    <td>
                        <button type="button" onclick="deleteInfo('${rentType.rentTypeId}','${rentType.rentTypeName}')"
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/rentType?action=delete" method="post">
