...
<div class="row">
    ...
    <div class="col-md-8">
        <p><a href="/serviceType?action=create">Add New Service Type</a></p>
        <p><span>${mess}</span></p>
        <table class="table table-striped">
            ...
            <c:forEach items="${serviceTypeList}" var="serviceType" varStatus="status">
                <tr>
                    <td>${status.count}</td>
                    <td>${serviceType.serviceTypeId}</td>
                    <td>${serviceType.serviceTypeName}</td>
                    <td>
                        <button type="button" onclick="deleteInfo('${serviceType.serviceTypeId}','${serviceType.serviceTypeName}')"
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/serviceType?action=delete" method="post">
